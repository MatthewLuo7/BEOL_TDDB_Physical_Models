...
# ==============================================================================
# 核心映射机制：
# - "GPR" 映射的是一个【加载兼训练的函数】对象
# - 各种 DPM 映射的是【类本身】（Class Type）
MODEL_REGISTRY = {
    "GPR": load_weibull_gpr_model,         # 指向加载函数 / Points to the loading function
    "PowerLaw": PowerLawDPMModel,          # 指向物理类 / Points to the class directly
    "SqrtE": SqrtEDPMModel,                # 指向物理类 / Points to the class directly
    "InverseE": InverseEDPMModel           # 指向物理类 / Points to the class directly
}
